from api.services.ai_coach_conversation_runtime_service import (
    ...
    execute_runtime_conversation,
    generate_runtime_response,
...
def test_execute_runtime_conversation():

    result = execute_runtime_conversation(
        runtime_context={
            "athlete_id": 1,
            "question": "Train?",
            "athlete_profile": {},
...
def test_generate_runtime_response():

    result = generate_runtime_response(
        athlete_id=1,
