...
def generate_coach_reasoning(
    ...
    if analysis.total_sessions < 3:
        ...
        recommendations.append("Aim for at least 3 running sessions per week.")
    else:
    ...
    if analysis.average_rpe >= 8:
        ...
        recommendations.append("Schedule an easy recovery run.")
    else:
    ...
    if analysis.total_training_load > 500:
        ...
        recommendations.append("Monitor fatigue and prioritise recovery.")
    ...
    if len(risks) == 0:
        comments.append("Excellent training week. Maintain your current progression.")

    elif len(risks) == 1:
        comments.append("Training is progressing well with one area to improve.")
