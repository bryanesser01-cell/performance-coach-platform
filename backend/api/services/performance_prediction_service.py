...
def predict_race_performance(
    ...
    predicted_time = current_time_seconds * (1 - improvement_percentage / 100)
...
def calculate_prediction_confidence(
    ...
    if training_consistency >= 75 and performance_trend == "improving":

        return "high"

    if training_consistency >= 50 or performance_trend == "improving":
...
def generate_prediction_range(
    ...
    margin = predicted_time_seconds * 0.02
...
def analyse_performance_prediction(
    ...
    confidence = calculate_prediction_confidence(
        training_consistency=performance_intelligence.get(
            "consistency_score",
            0,
        ),
        performance_trend=performance_intelligence.get(
            "trend",
            "stable",
        ),
    )
