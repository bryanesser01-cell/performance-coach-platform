...
def normalise_training_session(
    ...
    if source == "garmin":
        ...
        return {
            ...
            "avg_heart_rate": raw_data.get("average_hr"),
        ...
        return {
            ...
            "avg_heart_rate": raw_data.get("heart_rate"),
            "cadence": raw_data.get("cadence"),
        }
        ...
        return {
            ...
            "avg_heart_rate": raw_data.get("hr_average"),
        }
        ...
        return {
            ...
            "avg_heart_rate": raw_data.get("average_heartrate"),
        }
        ...
        return {
            ...
            "avg_heart_rate": raw_data.get("avg_heart_rate"),
            "cadence": raw_data.get("cadence"),
        }
...
def identify_training_source(
    ...
    return {
        "source": source,
        "supported": (source in supported_sources),
    }
...
def build_training_import_record(
    ...
    validation = validate_training_data(session)
