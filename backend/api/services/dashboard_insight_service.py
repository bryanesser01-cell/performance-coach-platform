...
def create_coach_recommendation(
    ...
    recommendations = {
        "performance_progression": (
            "Maintain training consistency " "and introduce targeted performance work."
        ),
        "continued_development": (
            "Continue building fitness while " "improving identified limitations."
        ),
        "foundation_building": (
            "Prioritise consistency, recovery, " "and gradual progression."
        ),
    }

    return {
        "focus": focus_data["focus"],
        "recommendation": recommendations[focus_data["focus"]],
